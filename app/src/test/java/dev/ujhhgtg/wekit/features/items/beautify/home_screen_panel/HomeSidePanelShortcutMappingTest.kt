    ...
    fun everyShortcutHasTheApprovedLabelAndSemanticIcon() {
        assertEquals(
            listOf(
                ...
                Triple(HomeSidePanelShortcut.PAYMENTS, "收付款", HomeSidePanelIconKind.WALLET),
                Triple(HomeSidePanelShortcut.FAVORITES, "收藏", HomeSidePanelIconKind.BOOKMARK),
                Triple(HomeSidePanelShortcut.MOMENTS, "朋友圈", HomeSidePanelIconKind.CAMERA),
                Triple(HomeSidePanelShortcut.VIDEO_CHANNELS, "视频号", HomeSidePanelIconKind.MOVIE),
                Triple(HomeSidePanelShortcut.MARK_ALL_READ, "清空未读", HomeSidePanelIconKind.MARK_CHAT_READ),
                Triple(HomeSidePanelShortcut.WEKIT_SETTINGS, "WeKit 设置", HomeSidePanelIconKind.EXTENSION),
            ),

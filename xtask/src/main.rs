...
//!   monet-test [OPTIONS] Validate Monet resources against APK/APKS/decoded samples.
...
enum Cmd {
    ...
    /// Validate Monet resource roles against APK, APKS, or decoded-resource samples.
    MonetTest(monet_test::MonetTestArgs),
...
fn main() -> Result<()> {
    ...
    match cli.command {
        ...
        Cmd::MonetTest(args) => monet_test::task_monet_test(args)?,
